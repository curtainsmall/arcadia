...
#define IM_VEC2_CLASS_EXTRA \
    ...
    constexpr ImVec2(const glm::i32vec2& i) : x(static_cast<float>(i.x)), y(static_cast<float>(i.y)) {} \
    operator glm::i32vec2() const { return glm::i32vec2(static_cast<int>(x), static_cast<int>(y)); }
