...
auto arcadia::window::on_event(const arcadia::event& event) -> bool
{
    return true;
}

void arcadia::window::on_update(delta_time_type delta_time)
{
    auto& event_queue = arcadia::event_queue::instance();
...
auto arcadia::window::get_title() const -> const std::string&
{
    return _title;
}

auto arcadia::window::set_title(const std::string& title) -> self_type&
{
    _title = title;
...
auto arcadia::window::get_size() const -> glm::ivec2
{
    glm::ivec2 size{};
...
auto arcadia::window::set_size(const glm::ivec2& size) -> self_type&
{
    glfwSetWindowSize(_glfw_window_ptr, size.x, size.y);
    return *this;
}

auto arcadia::window::get_pos() const -> glm::ivec2
{
    glm::ivec2 pos{};
...
auto arcadia::window::set_pos(const glm::ivec2& pos) -> self_type&
{
    glfwSetWindowPos(_glfw_window_ptr, pos.x, pos.y);
    return *this;
}

auto arcadia::window::get_swap_interval() const -> int
{
    return _swap_interval;
}

auto arcadia::window::set_swap_interval(int interval) -> self_type&
{
...
auto arcadia::window::get_visible() const -> bool
{
    return glfwGetWindowAttrib(_glfw_window_ptr, GLFW_VISIBLE);
}

auto arcadia::window::set_visible(bool visible) -> self_type&
{
    if(visible)
    {
...
auto arcadia::window::get_input_mode_cursor() const -> int
{
    return glfwGetInputMode(_glfw_window_ptr, GLFW_CURSOR);
}

auto arcadia::window::set_input_mode_cursor(int value) -> self_type&
{
    glfwSetInputMode(_glfw_window_ptr, GLFW_CURSOR, value);
    return *this;
}

auto arcadia::window::get_input_mode_sticky_keys() const -> int
{
    return glfwGetInputMode(_glfw_window_ptr, GLFW_STICKY_KEYS);
}

auto arcadia::window::set_input_mode_sticky_keys(int value) -> self_type&
{
    glfwSetInputMode(_glfw_window_ptr, GLFW_STICKY_KEYS, value);
    return *this;
}

auto arcadia::window::get_input_mode_sticky_mouse_buttons() const -> int
{
    return glfwGetInputMode(_glfw_window_ptr, GLFW_STICKY_MOUSE_BUTTONS);
}

auto arcadia::window::set_input_mode_sticky_mouse_buttons(int value) -> self_type&
{
    glfwSetInputMode(_glfw_window_ptr, GLFW_STICKY_MOUSE_BUTTONS, value);
    return *this;
}

auto arcadia::window::get_input_mode_lock_key_mods() const -> int
{
    return glfwGetInputMode(_glfw_window_ptr, GLFW_LOCK_KEY_MODS);
}

auto arcadia::window::set_input_mode_lock_key_mods(int value) -> self_type&
{
    glfwSetInputMode(_glfw_window_ptr, GLFW_LOCK_KEY_MODS, value);
    return *this;
}

auto arcadia::window::get_input_mode_raw_mouse_motion() const -> int
{
    return glfwGetInputMode(_glfw_window_ptr, GLFW_RAW_MOUSE_MOTION);
}

auto arcadia::window::set_input_mode_raw_mouse_motion(int value) -> self_type&
{
    glfwSetInputMode(_glfw_window_ptr, GLFW_RAW_MOUSE_MOTION, value);
    return *this;
}

void arcadia::window::_swap_buffers()
{
    arcadia::match<void>(
        _graphic_api,
...
auto arcadia::window::get_graphic_api() const -> const arcadia::graphic_api::type&
{
    return _graphic_api;
}

auto arcadia::window::get_multisample_count() const -> int
{
