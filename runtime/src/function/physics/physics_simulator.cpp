...
void PhysicsSimulator::SetJphTempAllocatorSize(JPH::uint jph_temp_allocator_size)
{
...
auto PhysicsSimulator::GetJphBodyIdStorage() const -> const jph_body_id_storage_type&
{
