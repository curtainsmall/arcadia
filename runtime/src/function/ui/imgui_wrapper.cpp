...
ARCADIA_API auto Arcadia::ImguiWrapper::DragQuatNormalized(const std::string& name, glm::quat& quat, float speed, float min, float max, const char* format, ImGuiSliderFlags flags) -> bool
{
    auto temp_quat = quat;
    auto deactivated = Arcadia::ImguiWrapper::DragQuat(name, temp_quat, speed, min, max, format, flags);
...
ARCADIA_API auto Arcadia::ImguiWrapper::DragQuatNormalized(const std::string& name, std::function<glm::quat()> getter, std::function<void(const glm::quat&)> setter, float speed, float min, float max, const char* format, ImGuiSliderFlags flags) -> bool
{
    auto quat = getter();
    auto deactivated = Arcadia::ImguiWrapper::DragQuatNormalized(name, quat, speed, min, max, format, flags);
    setter(quat);
    return deactivated;
}
