...
GlPipeline::GlPipeline(SelfType&& rhs) noexcept :
...
auto GlPipeline::operator=(SelfType&& rhs) noexcept -> SelfType&
{
    _GlUniformLocationCache = std::move(rhs._GlUniformLocationCache);
    _GlShaders = std::move(rhs._GlShaders);
...
auto GlPipeline::SetUniform(const std::string& name, GLfloat f0, GLfloat f1, GLfloat f2, GLfloat f3) -> SelfType&
{
    ACDA_GL_CALL(glUniform4f(_GetUniformLocation(name), f0, f1, f2, f3));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLfloat f0, GLfloat f1, GLfloat f2) -> SelfType&
{
    ACDA_GL_CALL(glUniform3f(_GetUniformLocation(name), f0, f1, f2));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLfloat f0, GLfloat f1) -> SelfType&
{
    ACDA_GL_CALL(glUniform2f(_GetUniformLocation(name), f0, f1));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLfloat f) -> SelfType&
{
    ACDA_GL_CALL(glUniform1f(_GetUniformLocation(name), f));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLint i0, GLint i1, GLint i2, GLint i3) -> SelfType&
{
    ACDA_GL_CALL(glUniform4i(_GetUniformLocation(name), i0, i1, i2, i3));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLint i0, GLint i1, GLint i2) -> SelfType&
{
    ACDA_GL_CALL(glUniform3i(_GetUniformLocation(name), i0, i1, i2));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLint i0, GLint i1) -> SelfType&
{
    ACDA_GL_CALL(glUniform2i(_GetUniformLocation(name), i0, i1));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLint i) -> SelfType&
{
    ACDA_GL_CALL(glUniform1i(_GetUniformLocation(name), i));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLuint u0, GLuint u1, GLuint u2, GLuint u3) -> SelfType&
{
    ACDA_GL_CALL(glUniform4ui(_GetUniformLocation(name), u0, u1, u2, u3));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLuint u0, GLuint u1, GLuint u2) -> SelfType&
{
    ACDA_GL_CALL(glUniform3ui(_GetUniformLocation(name), u0, u1, u2));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLuint u0, GLuint u1) -> SelfType&
{
    ACDA_GL_CALL(glUniform2ui(_GetUniformLocation(name), u0, u1));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, GLuint u) -> SelfType&
{
    ACDA_GL_CALL(glUniform1ui(_GetUniformLocation(name), u));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::vec4& vec) -> SelfType&
{
    ACDA_GL_CALL(glUniform4fv(_GetUniformLocation(name), 1, glm::value_ptr(vec)));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::vec3& vec) -> SelfType&
{
    ACDA_GL_CALL(glUniform3fv(_GetUniformLocation(name), 1, glm::value_ptr(vec)));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::vec2& vec) -> SelfType&
{
    ACDA_GL_CALL(glUniform2fv(_GetUniformLocation(name), 1, glm::value_ptr(vec)));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::mat4& mat) -> SelfType&
{
    ACDA_GL_CALL(glUniformMatrix4fv(_GetUniformLocation(name), 1, GL_FALSE, glm::value_ptr(mat)));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::mat3& mat) -> SelfType&
{
    ACDA_GL_CALL(glUniformMatrix3fv(_GetUniformLocation(name), 1, GL_FALSE, glm::value_ptr(mat)));
    return *this;
}

auto GlPipeline::SetUniform(const std::string& name, const glm::mat2& mat) -> SelfType&
{
    ACDA_GL_CALL(glUniformMatrix2fv(_GetUniformLocation(name), 1, GL_FALSE, glm::value_ptr(mat)));
    return *this;
}

auto GlPipeline::SetUniformBlockBinding(const std::string& name, GLuint index) -> SelfType&
{
